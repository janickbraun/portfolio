...
export function Hero() {
  return (
    <section className="relative w-full pt-16 md:pt-24 lg:pt-32 pb-12 overflow-hidden">
      {/* Background Decor */}
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left flex-1 order-2 md:order-1">
            <FadeIn delay={0.1}>
              ...
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4">
                ...
                <Link
                  href="/cv"
                  className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-zinc-900 border border-zinc-800 px-8 text-sm font-bold text-zinc-300 transition-all hover:bg-zinc-800 hover:text-zinc-50 hover:scale-[1.02]"
                >
