        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-8 items-center">
          <FadeIn className="flex flex-col gap-6" delay={0.1}>
            <h1 className="text-4xl font-bold tracking-tight text-zinc-50 sm:text-5xl lg:text-6xl text-balance">
              Hi, I'm <span className="text-primary">Janick</span>.
            </h1>
            <p className="text-lg text-zinc-400 max-w-xl text-balance">
              Passionate Fullstack Developer with a focus on excellent, performance-oriented web applications.
            </p>
            <div className="flex flex-wrap items-center gap-4 mt-4">
              <Link
                href="/projects"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-primary px-8 text-sm font-semibold text-zinc-950 transition-colors hover:bg-primary-hover"
              >
                View Projects
