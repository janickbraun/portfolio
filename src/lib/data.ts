...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Comic-style jump-and-run educational game for kids about biology.",
    longDescription:
  ...
  // Agency
  {
    ...
    longDescription:
      "Together with my co-founder Luis Baumer, we develop professional websites and digital solutions for small businesses as Grovider Agency. Focus on conversion rate, design, and SEO.",
    url: "https://grovider.de",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=1200",
    category: "agency",
    techStack: ["Agency", "Webdesign", "SEO"],
  },
  {
  ...
  // Non-Software
  {
    ...
    longDescription:
      "A short film project created for German class, adapting Goethe's classic drama 'Iphigenie auf Tauris' into a modern cinematic format referring to 'Star Wars'.",
...
export const cvItems: CVItem[] = [
  // Professional Experience
  {
    ...
    date: "2026-Present",
    description: "Development of software products and platform solutions like secondskate.",
    type: "experience",
  },
  {
    id: "telekom",
    ...
    date: "2024-2027",
    description: "Practical periods in various tech and sales teams within the corporation. Fullstack development, software engineering and B2B sales.",
    type: "experience",
  },
  {
    id: "grovider",
    ...
    date: "2023-Present",
    description: "Concept, design, and development of websites for small businesses.",
    type: "experience",
  },
  {
    id: "barber",
    role: "Barbershop Owner",
    organization: "Janicks' Hairsalon",
    date: "2023-2024",
    description: "Cutting hair for over 150 customers as a self-taught barber.",
    type: "experience",
  },
  {
    id: "grovider-ltda",
    role: "Junior Project Manager",
    organization: "Grovider Ltda.",
    date: "2023",
    description: "Managing and developing RapidTyper over the course of 3 months.",
    type: "experience",
  },
  // Education
  {
    ...
    date: "2024-2027",
    description: "Dual study parallel to working at Telekom. Focus on Business Information Systems, Software Engineering and IT-Management.",
    type: "education",
  },
  {
    id: "gym-penzberg",
    ...
    date: "2017-2024",
    description: "General higher education entrance qualification (Abitur) with a final grade of 1.7. Served 2 years as Student Representative and was an active member of both the Robotics Club (LEGO robots) and the School Website Club. Achievements include a 2nd place finish in the 'Planspiel Börse' stock market simulation and successful participation in the Federal Computer Science Competition (bwinf).",
    type: "education",
  },
  // Volunteer
  {
